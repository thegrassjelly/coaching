<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="UpdateUsers.aspx.cs" Inherits="Users_UpdateUsers" %>
            ...
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="pull-right">
                        <asp:Button ID="btnBack" class="btn btn-success" runat="server" Text="Back" OnClick="btnBack_OnClick" />
                        <asp:Button ID="btnSubmit" class="btn btn-primary"
                            runat="server" Text="Update Client" OnClick="btnSubmit_OnClick" />
                    </div>
                </div>
            </div>
        </div>
